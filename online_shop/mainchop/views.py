...
from .models import Boiler, Pomp, Category, LatestProducts, Customer, Cart, CartProduct
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Спасибо что сделали заказ! В ближайшее время с Вами свяжется менеджер.')
