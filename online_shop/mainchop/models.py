...
class CategoryManager(models.Manager):
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('boiler', 'pomp')
...
class Product(models.Model):
    ...
    slug = models.SlugField(unique=True)
    image = models.ImageField(verbose_name="Изоброжение товара")
...
class Pomp(Product):
    ...
    throughput = models.CharField(max_length=10, verbose_name='Производительность, max (л/мин)')
...
class Order(models.Model):
    ...
    last_name = models.CharField(max_length=255, verbose_name='Фаимлия')
